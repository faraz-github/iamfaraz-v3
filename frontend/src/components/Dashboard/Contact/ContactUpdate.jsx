...
const ContactUpdate = ({ token, selectedContact, setTabIndex }) => {
  // Context
  ...
  const [social, setSocial] = useState(selectedContact?.social);
  ...
  return (
    <Card variant="outlined" square>
      <CardHeader title="Contact Details" subheader="Update" />
